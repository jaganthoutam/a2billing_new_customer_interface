...
//define page title
$title = 'Call On Fly::Payment History';
...
$sql = "select count(*) as count from cc_logpayment where card_id=$id order by id desc";
...
$adjacents = 5;
$targetpage = "paymenthistory.php"; //your file name
...
$sql = "select id,date,payment,description,payment_type from cc_logpayment where card_id=$id order by id desc LIMIT $start, $limit";
...
$paymenttype 			=     $row["payment_type"];
	...
	if ($payment_type == "1") {$class = "danger"; }
		else {$class = "success";
